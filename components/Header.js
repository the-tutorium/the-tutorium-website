				...
				<div className={"mt-3 flex-grow items-start md:flex lg:mt-0" + (navbarOpen ? " flex" : " hidden")}>
					<div className="flex-col pl-4 text-xl md:flex-grow md:pl-0">
						<ul className="flex flex-wrap items-center justify-end flex-grow gap-2 pr-4 space-x-2 md:gap-6 md:space-x-6">
							<li>
								<a href="#mission" className="text-lg hover:text-gray-300 md:hover:text-gray-700">
									Mission
								</a>
							</li>
							<li>
								<a href="#courses" className="text-lg hover:text-gray-300 md:hover:text-gray-700">
									Courses
								</a>
							</li>
							<li>
								<a href="#team" className="text-lg hover:text-gray-300 md:hover:text-gray-700">
									Team
								</a>
							</li>
							<li>
								<a href="#contactus" className="text-lg hover:text-gray-300 md:hover:text-gray-700">
									Contact Us
								</a>
							</li>
							<li>
